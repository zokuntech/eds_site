          ...
          <div className="flex gap-5 max-md:flex-col">
            ...
            <div className="flex flex-col ml-5 w-[22%] max-md:ml-0 max-md:w-full">
              <button className="flex gap-4 justify-center items-center py-5 pr-7 pl-8 mt-32 w-full text-lg font-semibold tracking-wider leading-none text-white bg-sky-500 max-md:px-5 max-md:mt-10">
                ...
                <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/28d27f885d5deee823d04b9621d42439109b7daee19d4c0510567bde868b8835?placeholderIfAbsent=true&apiKey=e4387585966a4fd287da9e7858e1871a" alt="" className="object-contain shrink-0 self-stretch my-auto aspect-[1.93] w-[27px]" />
              </button>
            </div>
          </div>
        </div>
