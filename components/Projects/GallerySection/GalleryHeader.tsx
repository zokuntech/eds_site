  ...
  return (
    <header className="flex flex-col items-center self-center w-full max-w-[991px] text-neutral-600 max-md:max-w-full">
      ...
      <p className="mt-4 text-xl font-medium leading-7 text-center max-md:max-w-full">
        Explore the stunning transformations we've made for clients. Whether
        it's a bold exterior refresh or an intricate interior job, these
        projects demonstrate the skill and passion we bring to every space we
        work on.
      </p>
    </header>
  );
